      ...
      <div className="w-full flex-1 max-w-4xl mx-auto pt-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4.5 rounded-2xl border border-[var(--border-strong)] bg-[var(--surface-1)] p-4 sm:p-5 shadow-2xl backdrop-blur-xl">
          ...
          <div className="md:col-span-3 flex flex-col gap-3.5">
            <div>
              <h3 className="text-lg sm:text-xl font-bold text-[var(--text)] tracking-tight font-sans">
            ...
            {status === "success" ? (
              <div className="p-6 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-center flex flex-col items-center gap-3 my-auto">
                ...
                <h4 className="text-base font-bold text-[var(--text)] font-sans">Message Sent Successfully!</h4>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-[var(--surface-2)] border border-[var(--border)] text-xs sm:text-sm text-[var(--text)] placeholder-[var(--text-muted)] outline-none focus:border-sky-500/60 transition-all resize-none leading-relaxed font-sans"
                  />
                </div>
          ...
          <div className="md:col-span-2 flex flex-col justify-between gap-3 border-t md:border-t-0 md:border-l border-[var(--border)] pt-4 md:pt-0 md:pl-5">
            <div className="flex flex-col gap-2.5">
              ...
              >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <span className="text-xs font-sans text-[var(--text-muted)] block">Direct Email</span>
                    <span className="text-xs font-mono font-bold text-[var(--text)] block truncate">
                      {PERSONAL.email}
                    </span>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <span className="text-xs font-sans text-[var(--text-muted)] block">LinkedIn Profile</span>
                    <span className="text-xs font-mono font-bold text-[var(--text)] block truncate">
              ...
              >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <span className="text-xs font-sans text-[var(--text-muted)] block">GitHub Profile</span>
                    <span className="text-xs font-mono font-bold text-[var(--text)] block truncate">
